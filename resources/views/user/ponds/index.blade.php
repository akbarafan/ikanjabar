                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">
                                ...
                                {{ $pond->type === 'beton' ? 'bg-gray-100 text-gray-800' :
                                   ($pond->type === 'tanah' ? 'bg-yellow-100 text-yellow-800' :
                                   ($pond->type === 'viber' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800')) }}">
                                {{ ucfirst($pond->type) }}
                            </span>
                        </div>
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                            {{ $pond->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                            <div class="w-1.5 h-1.5 rounded-full mr-1.5
                                {{ $pond->status === 'active' ? 'bg-green-400' : 'bg-gray-400' }}"></div>
...
<div class="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-lg bg-white">
    <div class="mt-3">
        ...
        <form id="pondForm" class="space-y-4">
