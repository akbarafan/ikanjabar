            ...
            <div class="flex items-center justify-between h-14">
                <div class="flex items-center">
                    <button id="mobileMenuToggle"
                        class="text-white p-2 rounded-md hover:bg-white hover:bg-opacity-20 transition-colors md:hidden">
                ...
                <div class="flex items-center space-x-2">
                    <!-- Notifications -->
                    <button
                        class="text-white p-2 rounded-md hover:bg-white hover:bg-opacity-20 transition-colors relative">
                        <i class="fas fa-bell text-sm"></i>
                        <span
                            class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center text-xs">3</span>
                    </button>

                    <!-- Profile -->
                    <button
                        class="flex items-center text-white p-1 rounded-md hover:bg-white hover:bg-opacity-20 transition-colors">
                        <img class="h-6 w-6 rounded-full border border-white"
                            src="https://ui-avatars.com/api/?name=Admin&background=1e3a8a&color=fff" alt="Profile">
                    </button>
                </div>
            </div>
        </div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('admin.dashboard') }}"
                            class="flex items-center p-3 rounded-md hover:bg-gray-100 transition-colors">
